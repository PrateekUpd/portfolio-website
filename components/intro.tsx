...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Prateek.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/prateekupd/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/PrateekUpd"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
